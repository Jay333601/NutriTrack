...
export const ALL_RECIPES = [...HEALTHY_RECIPES, ...MORE_HEALTHY_RECIPES];
...
export default function NutritionTracker() {
  ...
  const recipeCategories = useMemo(
    () => ['All', ...new Set(ALL_RECIPES.map((recipe) => recipe.category))],
    []
  );
      ...
      <div className="n-shell">
        <div className="n-header">
          ...
          <div className="n-header-right">
            ...
            {selectedProfile ? (
              <>
                <div className="n-current-profile">
                  <span className="n-profile-dot"></span>
                ...
                <button
                  className="n-change-profile"
                  onClick={() => {
                    setNewProfileName('');
                    setSelectedProfile('');
                    localStorage.removeItem('nutrition-selected-profile');
                  }}
                >
                  Change profile
                </button>
