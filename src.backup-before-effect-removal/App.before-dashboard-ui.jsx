        ...
        <main className="mx-auto max-w-[1400px] p-5 md:p-8">
          ...
          {activePage === 'recipes' && (
            <PagePlaceholder
              ...
              description="Your recipe library will be connected here next."
            />
          )}
          ...
          {activePage === 'assistant' && (
            <PagePlaceholder
              ...
              description="Your nutrition assistant will be connected here next."
            />
          )}
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-[1.5fr_1fr]">
        ...
        <section className="rounded-3xl border border-[#dce1d8] bg-white p-6">
          ...
          <div className="mt-6 space-y-3">
            ...
            <MealRow
              meal="Breakfast"
              food="Open Log Food to see your meals"
              calories="—"
              muted
            />
            ...
            <MealRow
              meal="Lunch"
              food="Your saved meals appear in the tracker"
              calories="—"
              muted
            />
            ...
            <MealRow
              meal="Dinner"
              food="Real dashboard totals coming next"
              calories="—"
              muted
            />
      ...
      <section className="mt-6 rounded-3xl border border-[#dce1d8] bg-white p-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-[#7b847b]">
              Your nutrition history will appear here.
            </p>
          </div>
